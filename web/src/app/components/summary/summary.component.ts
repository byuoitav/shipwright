...
export class SummaryComponent implements OnInit {
  ...
  HelpWasSent() {
    ...
    this.roomAlerts.sentDate = new Date(timestamp)
    console.log(this.roomAlerts.sentDate.toLocaleString())
  }

  HelpHasArrived() {
    this.roomAlerts.helpArrived = true
    ...
    let timestamp = today + ", " + time
    this.roomAlerts.arriveDate = new Date(timestamp)
    console.log(this.roomAlerts.arriveDate.toLocaleString())
  }
