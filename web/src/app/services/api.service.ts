...
export class APIService {
  ...
  //     const alerts: Map<string, BuildingStatus> = this.converter.deserialize(data, Any);
  ...
  // public async getAlertsByRoom(roomID: string) {
  //   try {
  //     const data = await this.http.get("rooms/"+roomID+"/alerts", {headers: this.headers}).toPromise();
  //     const alerts = this.converter.deserialize(data, RoomStatus)

  //     return alerts;
  //   } catch (e) {
  //     throw new Error("error getting all alerts for the room " + roomID + ": " + e);
  //   }
  // }

  // public async getAlertsByBuilding(buildingID: string) {
  //   try {
  //     const data = await this.http.get("buildings/"+buildingID+"/alerts", {headers: this.headers}).toPromise();
  //     const alerts = this.converter.deserialize(data, BuildingStatus)

  //     return alerts;
  //   } catch (e) {
  //     throw new Error("error getting all alerts for the building " + buildingID + ": " + e);
  //   }
  // }
